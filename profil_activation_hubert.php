...
//if(file_exists(DOCROOT . "managers/employeManager.php")) echo "hello existe"; else echo "existe pas";
require_once(DOCROOT . "managers/employeManager.php");
if(isset($_GET['email']))
{
	if(isset($_GET['email']))
	{
		?><input type='hidden' id='email_emp'  value='<?php echo $_GET['email']; ?>'/><?php	
	}
}
...
<head>
    ...
    <link 
	rel="stylesheet" href="assets/bootstrap/css/bootstrap.css" type="text/css">
    ...
    <div class="secondary-navigation-wrapper">
        <div class="container">
            ...
            <ul class="secondary-navigation list-unstyled pull-right">
                <li><a  href="http://mbacentereurope.eu/profil.php"><i class="fa fa-user"></i><?php /*"#tab-profile" data-toggle="tab"*/ if(isset($_SESSION['user'])){echo $_SESSION['nom'];} elseif(isset($_SESSION['employe'])){echo $_SESSION['nom'];}?></a></li>
                ...
                <!--<li><a href="http://mbacentereurope.eu/mbacenter/managers/deconnecter.php">Log Out</a></li>-->
				<li><a href="http://mbacentereurope.eu/managers/deconnecter.php">Log Out</a></li>
...
<div id="page-content">
    <div class="container">
        <header><h1>Employe Activation Account</h1></header>
                            ...
                            <section id="my-profile">
                                ...
                                <div class="my-profile">
                                    ...
                                    <article>
                                        <div class="table-responsive">
                                            <table class="my-profile-table">
												...
												<?php 
													...
													$result = $employeManager->selectEmpByEmail($_GET['email']);			
												?>
                                                <tr>
                                                    <td class="title">Full Name</td>
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="name" disabled='true' value='<?php echo $result['nom']; ?>'>
                                                        </div><!-- /input-group -->
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="email" disabled='true' value='<?php echo $result['email']; ?>'>
                                                        </div><!-- /input-group -->
                                                    </td>
                                                </tr>
													<tr>
														...
														<td>
															<div class="input-group">
																<input type="text" id="gsm" disabled='true' value='<?php echo $result['gsm']; ?>'/> 
															</div><!-- /input-group -->
														</td>
													</tr>
                                                <tr>
                                        ...
                                        <button type="button" class="btn pull-right" id="btn_activation">Activate</button>
...
if(isset($_GET['email']))
{
	?><script type="text/javascript" src="assets/js/traitement_profil_hubert.js"></script><?php
}
?>
</body>
</html>